---
article_id: CUB-11-C
title: "Koordinasi Instalasi Cubicle dengan MEP, Furniture, dan Operasional"
slug: "koordinasi-instalasi-cubicle-dengan-mep"
description: "Map service isolation, penetrations, cable/furniture interfaces, access, shutdowns, temporary arrangements, trade sign-offs, and protection"
status: outline
publication_date: "2026-04-09"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: CUB-11
primary_intent: "Sequence interfaces safely"
reader_community: "Cubicle.id"
reader_address: "Teman Cubicle.id"
final_route: "/artikel/koordinasi-instalasi-cubicle-dengan-mep.html"
...
# Koordinasi Instalasi Cubicle dengan MEP, Furniture, dan Operasional

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Koordinasi Instalasi Cubicle dengan MEP, Furniture, dan Operasional”
- **Reader and situation:** Site coordinator in a multi-trade project
- **Reader outcome:** Map service isolation, penetrations, cable/furniture interfaces, access, shutdowns, temporary arrangements, trade sign-offs, and protection
- **Primary intent:** Sequence interfaces safely
...
- **Scope boundary:** Does not instruct electrical isolation or connections; qualified personnel and site procedures own them, while CUB-14-D owns occupied phasing
- **Final public route:** `/artikel/koordinasi-instalasi-cubicle-dengan-mep.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Koordinasi Instalasi Cubicle dengan MEP, Furniture, dan Operasional**.
...
- `CUB-11-A` → `/artikel/hold-point-instalasi-cubicle.html` — Checklist Hold Point Instalasi Cubicle dari Survei hingga Handover
- `CUB-11-B` → `/artikel/pemeriksaan-substrate-sebelum-instalasi-cubicle.html` — Pemeriksaan Substrate sebelum Memasang Cubicle
- `CUB-11-D` → `/artikel/qc-panel-pintu-hardware-sambungan.html` — QC Panel, Pintu, Hardware, dan Sambungan Cubicle
- `CUB-11-E` → `/artikel/perlindungan-cubicle-setelah-instalasi.html` — Melindungi Cubicle setelah Terpasang hingga Serah Terima
...
- **Tie back to this article:** Keep the explanation specific to “Koordinasi Instalasi Cubicle dengan MEP, Furniture, dan Operasional”.
