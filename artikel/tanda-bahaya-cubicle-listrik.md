---
article_id: CUB-05-F
title: "Tanda Bahaya Cubicle Listrik dan Kapan Area Harus Diamankan"
slug: "tanda-bahaya-cubicle-listrik"
description: "Identify observable warnings, do-not-touch boundaries, area control, reporting inputs, and qualified-response escalation"
status: outline
publication_date: "2025-12-06"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: CUB-05
primary_intent: "Escalate abnormal warning signs"
reader_community: "Cubicle.id"
reader_address: "Kawan Cubicle.id"
final_route: "/artikel/tanda-bahaya-cubicle-listrik.html"
...
# Tanda Bahaya Cubicle Listrik dan Kapan Area Harus Diamankan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Tanda Bahaya Cubicle Listrik dan Kapan Area Harus Diamankan”
- **Reader and situation:** Operator noticing odor, heat, sound, damage, moisture, or alarms
- **Reader outcome:** Identify observable warnings, do-not-touch boundaries, area control, reporting inputs, and qualified-response escalation
- **Primary intent:** Escalate abnormal warning signs
...
- **Scope boundary:** Does not instruct opening, diagnosis, switching, testing, firefighting, or repair; CUB-13-E owns documentation-led failure review
- **Final public route:** `/artikel/tanda-bahaya-cubicle-listrik.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Tanda Bahaya Cubicle Listrik dan Kapan Area Harus Diamankan**.
...
- **Tie back to this article:** Keep the explanation specific to “Tanda Bahaya Cubicle Listrik dan Kapan Area Harus Diamankan”.
