---
article_id: CUB-11-B
title: "Pemeriksaan Substrate sebelum Memasang Cubicle"
slug: "pemeriksaan-substrate-sebelum-instalasi-cubicle"
description: "Check identity, level/plumb, strength evidence, finishes, moisture, embedded services, edge zones, damage, and approval/escalation"
status: outline
publication_date: "2026-04-06"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: CUB-11
primary_intent: "Verify installation base conditions"
reader_community: "Cubicle.id"
reader_address: "Kawan Cubicle.id"
final_route: "/artikel/pemeriksaan-substrate-sebelum-instalasi-cubicle.html"
...
# Pemeriksaan Substrate sebelum Memasang Cubicle

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Pemeriksaan Substrate sebelum Memasang Cubicle”
- **Reader and situation:** Installer or supervisor before setting out
- **Reader outcome:** Check identity, level/plumb, strength evidence, finishes, moisture, embedded services, edge zones, damage, and approval/escalation
- **Primary intent:** Verify installation base conditions
...
- **Scope boundary:** Does not design anchors or repair structure; CUB-07-D owns anchor inputs and responsible engineers own remediation
- **Final public route:** `/artikel/pemeriksaan-substrate-sebelum-instalasi-cubicle.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Pemeriksaan Substrate sebelum Memasang Cubicle**.
...
- **Tie back to this article:** Keep the explanation specific to “Pemeriksaan Substrate sebelum Memasang Cubicle”.
