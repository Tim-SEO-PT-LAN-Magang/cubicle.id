...
Reader community name: `Cubicle.id`
...
- Address the reader warmly as `Sobat Cubicle.id`, `Kawan Cubicle.id`, or `Teman Cubicle.id`. Use the exact opening salutation assigned inside the article file.
